...
class Graphs:
    def makeGraph1(self, city, data, startDate, endDate):
        ...
        plt.xlabel('Days')
        plt.ylabel('Temp')
        # Make legend for min and max temp.
...
class DataBase_Retrieval:
    def getData(self):
        ...
        for city in cities:
            ...
            dict1 = {'sys_date': sys_date, 'weather': weather, 'temp': temp, 'pressure': pressure, 'humidity': humidity, 'min_temp': min_temp, 'max_temp': max_temp, 'wind_speed': wind_speed}
...
graph1 = Graphs()
graph2 = Graphs()
graph1.makeGraph1(city1, data1, startDate, endDate)